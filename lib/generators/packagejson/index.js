...
module.exports = class PackageJsonGenerator extends Generator {
  ...
  writing() {
    ...
    if (pkg.name === '@ornikar/shared-configs') {
      pkg.scripts = {
        ...pkg.scripts,
        'lint:prettier': './@ornikar/repo-config/bin/ornikar-prettier-check.sh',
        'lint:prettier:fix': './@ornikar/repo-config/bin/ornikar-prettier-fix.sh',
      };
    }
