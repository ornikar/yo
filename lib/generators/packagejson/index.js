      ...
      packageLocations.forEach((packageLocation) => {
        ...
        if (pkg?.devDependencies?.['@ornikar/rollup-config']) {
          if (wpkg.private) {
            ...
            const entries = wpkg.ornikar?.entries || ['index'];
            ...
            entries.forEach((entryName) => {
              ...
              wpkg.exports[entryPath] = {
                node: {
                  require: './dist/index-node-14.17.cjs.js',
                },
                browser: {
                  import: `./dist/index-browser-all.es${hasPeerDependencyReactNative ? '.web' : ''}.js`,
                },
              };
              ...
              if (hasPeerDependencyReactNative) {
                wpkg.exports[entryPath].node = {
                  ...wpkg.exports[entryPath].node,
                  web: {
                    require: './dist/index-node-14.17.cjs.web.js',
                  },
                };
